        ...
        <>
          <div className="px-[10%] py-20 font-poppins flex flex-col gap-8 bg-[#003145] text-[#ffffff]">
            ...
            <div className="flex flex-row max-lg:flex-col justify-between items-center max-lg:items-start max-lg:gap-10">
              <div>
                <div className="text-[40px] font-semibold">{hackathonName}</div>
                <div className="text-[18px] font-inter font-medium">
                  Identify the class to which each butterfly belongs to
                </div>
              </div>
              <img src={imageURL} alt={hackathonName} className="rounded-3xl" />
            </div>
          ...
          <div className="px-[10%] py-4 shadow-custom flex flex-row justify-between">
            ...
            <div className="flex flex-row gap-4 max-sm:flex-col">
              ...
              <button
                className="border border-[#DC1414] bg-[#ffffff] text-[#DC1414] rounded-[10px] px-4 py-1"
          ...
          <div className="px-[10%] py-20">
            <p className="text-[18px] font-medium text-[#64607D] mr-60 max-md:mr-28 max-sm:mr-0">
              ...
              efficient model.
              <br />
              <br /> Your Task is to build an Image Classification Model using
              CNN that classifies to which class of weather each image belongs
              to.
            </p>
          </div>
        </>
